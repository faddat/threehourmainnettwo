...
func NewMsgCreatePost(creator string, title string, body string, ipfs string) *MsgCreatePost {
...
func NewMsgUpdatePost(creator string, id uint64, title string, body string, ipfs string) *MsgUpdatePost {
